            ...
            parameters = e.tensorProperties.Parameters
                ...
                .Select((parameter, i) => {
                    ...
                    try {
                        ...
                        asset = Instantiate(textDescriptionPrefab, descriptionContainer.transform);
                        asset.Parameter = text;
                    } catch (Exception ef) {
                        Debug.Log(ef.Message);
                        asset = Instantiate(laTeXDescriptionPrefab, descriptionContainer.transform);
                        asset.Parameter = parameter.LaTeX;
                    }
                    asset.Description = parameter.Description;
                    asset.RectTransform.Translate(currentHeight * Vector3.down);
                    currentHeight += asset.RectTransform.rect.height;
                    return asset;
                }).ToArray();
        };
    }
