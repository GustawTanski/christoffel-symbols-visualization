...
public class ChristofellApplication : MonoBehaviour {
    ...
    public ChristofellEvent<MiniCubeRotatorClickedEventArgs> miniCubeRotatorClicked = new ChristofellEvent<MiniCubeRotatorClickedEventArgs>();
    ...
    public ChristofellEvent<CursorStateChangedEventArgs> cursorStateChanged = new ChristofellEvent<CursorStateChangedEventArgs>();
}